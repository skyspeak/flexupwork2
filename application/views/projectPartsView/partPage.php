        ...
        <section class="well well-lg">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" name="part_description" id="projectDescription"><?php echo $partDetails['partData']['part_description'];?></textarea>
                </div>
